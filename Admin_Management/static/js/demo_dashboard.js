...
// function check1() {
//     cb = document.getElementById("toggles");
...
//     let submitButton = document.querySelector('button.btn.btn-primary.pull-right');

//     // Enable or disable the submit button based on checkbox status
//     submitButton.disabled = !atLeastOneChecked || (atLeastOneChecked && !allChecked);
// }


function checkAnyCheckbox() {
    let checkboxes = document.querySelectorAll('.icheck');
    let submitButton = document.querySelector('button.btn.btn-primary.pull-right');
...
function check1() {
    let cb = document.getElementById("toggles");
    let checkboxes = document.querySelectorAll('.icheck');
...
function showDropdowns() {
    var empCat = document.getElementById("emp_cat").value;
    var emp_array=empCat.split("+");
    var additionalDropdowns = document.getElementById("additionalDropdowns");

    if (emp_array[1] === '4') { // Change 'desired_value' to the actual value you are checking
